...
export type ToolSurface = "understudy_code" | "playwright_code" | "cdp_code" | "playwright_mcp" | "chrome_devtools_mcp" | "browse_cli";
export type StartupProfile = "runner_provided_local_cdp" | "runner_provided_browserbase_cdp" | "tool_launch_local" | "tool_attach_local_cdp" | "tool_create_browserbase" | "tool_attach_browserbase";
export type CoreCapability = "session" | "navigation" | "evaluation" | "screenshot" | "viewport" | "wait" | "click" | "hover" | "scroll" | "type" | "press" | "tabs" | "representation";
