...
export const resolveRuntimeTasksRoot = (callerFilePath, packageRootDir) => {
...
export const getRuntimeTasksRoot = () => resolveRuntimeTasksRoot(getCurrentFilePath(), getPackageRootDir());
