...
function makeResult(name, success) {
    return {
        input: {
            name,
...
describe("generateSummary", () => {
    it("preserves cross-cutting categories for category-qualified task names", async () => {
        ...
        ], "regression-3fb31541", "https://www.braintrust.dev/app/Browserbase/p/stagehand/experiments/regression-3fb31541");
    ...
    it("includes Braintrust scores when provided", async () => {
        await generateSummary([
            makeResult("observe/observe_github", true),
            makeResult("observe/observe_github", false),
        ], "regression-b0b8a8f2", "https://www.braintrust.dev/app/Browserbase/p/stagehand/experiments/regression-b0b8a8f2", {
            "Exact match": {
                name: "Exact match",
                score: 0.875,
                improvements: 0,
