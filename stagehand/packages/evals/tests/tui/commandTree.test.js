...
import { buildCommandTree, dispatch, findChild, resolveCommand, tokenizeArgv, walkPath, } from "../../tui/commandTree.js";
...
describe("dispatch", () => {
    ...
    it("routes bare `help` to the current context's printHelp", async () => {
        ...
        tree.children[2].printHelp = printExperimentsHelp;
        const ctx = makeCtx();
        ctx.setContextPath?.(["experiments"]);
