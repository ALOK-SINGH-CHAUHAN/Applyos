...
async function runCli(args) {
    try {
        const { stdout, stderr } = await exec(process.execPath, ["--import", "tsx", CLI_PATH, ...args], {
            cwd: repoRoot,
            timeout: 15_000,
