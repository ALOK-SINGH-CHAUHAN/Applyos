 ...
 */
export declare function generateExperimentName({ evalName, category, }: {
    evalName?: string;
    category?: string;
    environment?: string;
    toolSurface?: string;
...
export declare function normalizeAgentModelEntries(models: string[] | AgentModelEntry[]): AgentModelEntry[];
