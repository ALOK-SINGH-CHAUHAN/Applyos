 ...
 */
export function exactMatch(args) {
    return {
        name: "Exact match",
 ...
 */
export function errorMatch(args) {
    return {
        name: "Error rate",
        score: typeof args.output === "object" && args.output.error !== undefined
            ? 1
            : 0,
    };
}
