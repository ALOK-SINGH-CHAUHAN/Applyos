...
export const buildOnlineMind2WebTestcases = (models) => {
    const mind2webFilePath = path.join(getPackageRootDir(), "datasets", "onlineMind2Web", "onlineMind2Web.jsonl");
