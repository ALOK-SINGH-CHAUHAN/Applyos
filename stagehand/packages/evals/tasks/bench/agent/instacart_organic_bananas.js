...
export default defineBenchTask({ name: "agent/instacart_organic_bananas" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://www.instacart.com";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Search for organic bananas on Instacart and list the top 3 prices along with their retailer names. Only use http://instacart.com to achieve the task. Don't go to any other site. The task is achievable with just navigation from this site.";
        const taskSpec = {
