...
export default defineBenchTask({ name: "agent/arxiv_gpt_report" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        ...
        const taskSpec = {
            ...
            precomputedRubric: adHocRubric(`did the agent complete this task successfully? ${instruction} The correct answer is '${expected}'.`),
        };
