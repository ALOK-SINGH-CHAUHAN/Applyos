...
export default defineBenchTask({ name: "agent/github" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://github.com/";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Find a Ruby repository on GitHub that has been updated in the past 3 days and has at least 1000 stars.";
        const taskSpec = {
            id: "agent/github",
            instruction,
            initUrl,
            precomputedRubric: adHocRubric("Ruby repository on GitHub that has been updated in the past 3 days and has at least 1000 stars."),
        };
