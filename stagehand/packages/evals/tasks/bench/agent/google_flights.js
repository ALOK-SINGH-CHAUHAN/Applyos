...
export default defineBenchTask({ name: "agent/google_flights" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        ...
        const taskSpec = {
            ...
            instruction,
            initUrl,
            precomputedRubric: adHocRubric("Does the page show flights (options, available flights, not a search form) from San Francisco to New York?"),
        };
