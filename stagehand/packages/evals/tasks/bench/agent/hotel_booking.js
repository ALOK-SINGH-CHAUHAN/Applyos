...
export default defineBenchTask({ name: "agent/hotel_booking" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://www.booking.com/";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Find a hotel in Sydney with a rating of 8 or higher, providing free Wi-Fi and parking, available for a four-night stay starting on December 10, 2025.";
        const taskSpec = {
            id: "agent/hotel_booking",
            instruction,
            initUrl,
            precomputedRubric: adHocRubric("Does the page show a hotel in Sydney with a rating of 8 or higher, providing free Wi-Fi and parking, available for a four-night stay starting on December 10, 2025?"),
        };
