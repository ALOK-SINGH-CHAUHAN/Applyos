...
export default defineBenchTask({ name: "agent/all_recipes" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://www.allrecipes.com/";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Search for a recipe for Beef Wellington on Allrecipes that has at least 200 reviews and an average rating of 4.5 stars or higher. List the main ingredients required for the dish.";
        const taskSpec = {
