...
export default defineBenchTask({ name: "agent/github_react_version" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://github.com/";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Check the latest release version of React and the date it was published.";
        const taskSpec = {
