...
export default defineBenchTask({ name: "agent/google_maps_2" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://maps.google.com";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Search for the fastest walking route from La Puerta de Alcalá to La Puerta del Sol";
        const taskSpec = {
