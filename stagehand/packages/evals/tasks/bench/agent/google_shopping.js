...
export default defineBenchTask({ name: "agent/google_shopping" }, async ({ debugUrl, sessionUrl, logger, agent, v3 }) => {
    try {
        const initUrl = "https://www.google.com/shopping";
        const page = v3.context.pages()[0];
        await page.goto(initUrl);
        const instruction = "Find a drip coffee maker that is on sale and within $25-60 and has a black finish";
        const taskSpec = {
            id: "agent/google_shopping",
            instruction,
            initUrl,
            precomputedRubric: adHocRubric("Does the page show a drip coffee maker that is on sale and within $25-60 and has a black finish?"),
        };
