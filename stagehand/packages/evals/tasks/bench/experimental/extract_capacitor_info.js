...
import { z } from "zod";
export default defineBenchTask({ name: "extract_capacitor_info" }, async ({ logger, debugUrl, sessionUrl, v3 }) => {
    try {
        const page = v3.context.pages()[0];
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/capacitor/");
        const result = await v3.extract("Extract the ECCN Code, RoHS Status, and Impedance.", z.object({
            ECCN_code: z.string(),
