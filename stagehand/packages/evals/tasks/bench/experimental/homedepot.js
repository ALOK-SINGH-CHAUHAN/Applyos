...
import { z } from "zod";
export default defineBenchTask({ name: "homedepot" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    try {
        ...
        const productSpecs = await v3.extract("Extract the Primary exact Burner BTU of the product", z.object({
