...
export default defineBenchTask({ name: "extract_press_releases" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    ...
    try {
        ...
        const rawResult = await v3.extract("extract the title and corresponding publish date of EACH AND EVERY press releases on this page. DO NOT MISS ANY PRESS RELEASES.", schema);
        ...
        const isItemMatch = (item, expected) => {
