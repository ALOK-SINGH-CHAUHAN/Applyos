...
export default defineBenchTask({ name: "observe_simple_google_search" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    try {
        ...
        const expectedUrl = "https://browserbase.github.io/stagehand-eval-sites/sites/google/openai.html";
