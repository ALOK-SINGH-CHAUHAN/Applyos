...
export default defineBenchTask({ name: "oopif_in_csr" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    ...
    try {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/oopif-in-open-shadow-dom/");
