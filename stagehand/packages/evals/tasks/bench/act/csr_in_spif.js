...
export default defineBenchTask({ name: "csr_in_spif" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    ...
    try {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/closed-shadow-dom-in-spif/");
