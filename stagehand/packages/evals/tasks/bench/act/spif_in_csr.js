...
export default defineBenchTask({ name: "spif_in_csr" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    ...
    try {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/spif-in-closed-shadow-dom/");
