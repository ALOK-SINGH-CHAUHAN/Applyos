...
export default defineBenchTask({ name: "hidden_input_dropdown" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    /**
    ...
    try {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/hidden-input-dropdown/");
