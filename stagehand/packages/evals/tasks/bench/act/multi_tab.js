...
export default defineBenchTask({ name: "multi_tab" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    try {
        ...
        let expectedUrl = "https://browserbase.github.io/stagehand-eval-sites/sites/five-tab/page5.html";
