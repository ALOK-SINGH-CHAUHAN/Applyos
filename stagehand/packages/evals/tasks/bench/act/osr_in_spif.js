...
export default defineBenchTask({ name: "osr_in_spif" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    ...
    try {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/open-shadow-root-in-spif/");
