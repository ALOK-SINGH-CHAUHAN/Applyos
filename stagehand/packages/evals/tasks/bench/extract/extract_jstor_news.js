...
import { z } from "zod";
export default defineBenchTask({ name: "extract_jstor_news" }, async ({ logger, debugUrl, sessionUrl, v3, }) => {
    try {
        ...
        const result = await v3.extract("Extract ALL the news report titles and their dates.", z.object({
        ...
        const firstItemMatches = reports[0].report_name === expectedFirstItem.report_name &&
        ...
        const lastItemMatches = reports[reports.length - 1].report_name ===
