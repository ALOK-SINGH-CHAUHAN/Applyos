...
export default defineBenchTask({ name: "extract_aigrant_targeted" }, async ({ logger, debugUrl, sessionUrl, v3 }) => {
    try {
        ...
        const company = await v3.extract("Extract the company name.", z.object({
