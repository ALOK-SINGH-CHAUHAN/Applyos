...
export default defineBenchTask({ name: "extract_aigrant_targeted_2" }, async ({ logger, debugUrl, sessionUrl, v3 }) => {
    try {
        ...
        const company = await v3.extract("Extract the name of the company that comes after 'Coframe'.", z.object({
