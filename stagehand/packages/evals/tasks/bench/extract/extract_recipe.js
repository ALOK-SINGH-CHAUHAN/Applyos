...
import { z } from "zod";
export default defineBenchTask({ name: "extract_recipe" }, async ({ debugUrl, sessionUrl, v3, logger }) => {
    try {
        const page = v3.context.pages()[0];
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/allrecipes-extract/", {
            waitUntil: "domcontentloaded",
        });
        const selector = "/html/body/main/article/div[3]/div[3]/div[4]";
        const recipeDetails = await v3.extract("Extract the title of the number of tablespoons of olive oil needed for the steak, and the number of teaspoons of lemon juice needed for the mushroom pan sauce.", z.object({
