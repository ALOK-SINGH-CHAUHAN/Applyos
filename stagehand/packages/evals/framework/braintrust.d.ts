...
export declare function hasBraintrustApiKey(): boolean;
export declare function loadBraintrust(): Promise<typeof import("braintrust")>;
/**
...
type TracedSpanOptions = StartSpanArgs & {
    name: string;
};
export declare function tracedSpan<T>(fn: TracedFn<T>, options: TracedSpanOptions): Promise<T>;
export {};
