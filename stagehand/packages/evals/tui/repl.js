...
import { buildCommandTree, dispatch, renderPrompt, tokenize, } from "./commandTree.js";
...
export async function startRepl(entryDir, options = {}) {
    ...
    try {
        ...
        console.error(red(`  Failed to discover tasks: ${err.message}`));
        process.exit(1);
    }
    // ─── Onboarding chrome ───────────────────────────────────────────────
