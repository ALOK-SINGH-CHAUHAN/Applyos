...
const CORE_TEMPLATE = (name) => `import { defineCoreTask } from "../../../framework/defineTask.js";
...
`;
const BENCH_TEMPLATE = (name) => `import { defineBenchTask } from "../../../framework/defineTask.js";
...
export function scaffoldTask(args) {
    ...
    if (!/^[a-z][a-z0-9_-]*$/.test(category)) {
        console.log(red(`  Invalid category "${category}". Use lowercase letters, numbers, underscores, or hyphens.`));
        return null;
    }
