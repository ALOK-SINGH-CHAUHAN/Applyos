...
import { z } from "zod";
async function recordPlaywrightVideo(stagehand) {
    ...
    const { primitives } = await stagehand.extract("list the four Stagehand primitives that are described on the page", z.object({
