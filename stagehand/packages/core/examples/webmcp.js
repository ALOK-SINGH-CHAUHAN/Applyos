...
async function example(stagehand) {
    ...
    await page.goto("https://googlechromelabs.github.io/webmcp-tools/demos/react-flightsearch/", { waitUntil: "load" });
    ...
    if (flightSearch) {
        const invocation = await page.invokeWebMCPTool(flightSearch.name, {
            origin: "SFO",
            destination: "JFK",
            tripType: "round-trip",
