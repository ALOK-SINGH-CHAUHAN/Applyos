...
async function example(stagehand) {
    ...
    const result = await agent.execute("Use one of the tools from Exa to search for the top headphones of 2025. After doing so, use the browser and go through the checkout flow for the best one.");
    console.log(result);
}
(async () => {
