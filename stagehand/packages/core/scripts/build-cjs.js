...
fs.writeFileSync(`${repoRoot}/packages/core/dist/cjs/index.js`, `"use strict";
module.exports = require("./lib/v3/index.js");
`);
fs.writeFileSync(`${repoRoot}/packages/core/dist/cjs/cli.js`, `#!/usr/bin/env node
"use strict";
require("./lib/v3/cli.js");
`);
fs.writeFileSync(`${repoRoot}/packages/core/dist/cjs/index.d.ts`, `export * from "./lib/v3/index";
export { default } from "./lib/v3/index";
`);
fs.writeFileSync(`${repoRoot}/packages/core/dist/cjs/package.json`, '{\n  "type": "commonjs"\n}\n');
