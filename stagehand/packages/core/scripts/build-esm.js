...
fs.writeFileSync(`${repoRoot}/packages/core/dist/esm/package.json`, '{\n  "type": "module"\n}\n');
fs.writeFileSync(`${repoRoot}/packages/core/dist/esm/index.js`, `export * from "./lib/v3/index.js";
export { default } from "./lib/v3/index.js";
`);
fs.writeFileSync(`${repoRoot}/packages/core/dist/esm/index.d.ts`, `export * from "./lib/v3/index.js";
export { default } from "./lib/v3/index.js";
`);
