...
import { ensureParentDir, parseListFlag, splitArgs, collectFiles, toSafeName, normalizeVitestArgs, findJunitPath, hasReporterName, writeCtrfFromJunit, } from "./test-utils.js";
...
if (!fs.existsSync(testsDir)) {
    console.error("Missing packages/core/dist/esm/tests/unit. Run pnpm run build:esm first.");
    process.exit(1);
}
