...
const WEBMCP_TEST_SITE = "https://browserbase.github.io/stagehand-eval-sites/sites/webmcp-test/";
test.describe("Page WebMCP e2e", () => {
    ...
    test("lists and invokes tools registered by the page", async () => {
        ...
        const invocation = await page.invokeWebMCPTool("calculateSum", { a: 19, b: 23 }, { frameId: calculateSum.frameId, timeoutMs: 5_000 });
