...
describe("Runtime Utils public API types", () => {
    describe("injectUrls", () => {
        it("has correct parameter types", () => {
            expectTypeOf(Stagehand.injectUrls).parameters.branded.toEqualTypeOf();
        });
    });
    describe("isRunningInBun", () => {
        it("has correct parameter types", () => {
            expectTypeOf(Stagehand.isRunningInBun).parameters.branded.toEqualTypeOf();
        });
    });
    describe("loadApiKeyFromEnv", () => {
        it("has correct parameter types", () => {
            expectTypeOf(Stagehand.loadApiKeyFromEnv).parameters.branded.toEqualTypeOf();
        });
    });
