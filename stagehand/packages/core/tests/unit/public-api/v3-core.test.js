...
describe("V3 Core public API types", () => {
    describe("Stagehand", () => {
        ...
        it("act accepts Action as first parameter", () => {
            const mockAction = {};
            expectTypeOf().toBeCallableWith(mockAction, {});
        });
        it("extract accepts instruction and schema", () => {
            const mockSchema = {};
            expectTypeOf().toBeCallableWith("instruction", mockSchema, {});
        });
        it("observe accepts instruction and options", () => {
            expectTypeOf().toBeCallableWith("instruction", {});
        });
    ...
    describe("V3Evaluator", () => {
        ...
        it("accepts legacy evaluator backend options", () => {
            const mockV3 = {};
            expectTypeOf().toBeConstructibleWith(mockV3, {
                backend: "legacy",
            });
        });
    });
    ...
    describe("connectToMCPServer", () => {
        it("has correct parameter types", () => {
            expectTypeOf(Stagehand.connectToMCPServer).parameters.branded.toEqualTypeOf();
        });
    });
