...
import { collectCanonicalEvidence, isImageEvidence, isTextEvidence, } from "../../lib/v3/verifier/evidence.js";
...
function makeTrajectory(steps, extra = {}) {
    return {
...
describe("collectCanonicalEvidence", () => {
    it("includes tier-1 agent screenshots, probe screenshots, and the final observation", async () => {
        ...
        expect(evidence.some((e) => isTextEvidence(e) && e.content.includes("FINAL ARIA TREE"))).toBe(true);
    });
