...
import { buildAgentEvidenceFromStepFinished, REDACTED_INLINE_IMAGE, } from "../../lib/v3/verifier/evidenceNormalization.js";
describe("buildAgentEvidenceFromStepFinished", () => {
    ...
    it("lifts inline screenshot payloads into image evidence and redacts JSON", () => {
        ...
        if (imageModality?.type === "image") {
            expect(imageModality.bytes).toEqual(Buffer.from(inlineScreenshot, "base64"));
        }
    });
});
