...
describe("formatTreeLine", () => {
    ...
    it("renders both flags when a node carries both states", () => {
        ...
        expect(outline).toBe("[ax-12] menuitemcheckbox: Hybrid state [selected] [checked]");
    });
});
