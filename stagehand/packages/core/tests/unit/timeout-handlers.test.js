...
import { ActTimeoutError, ExtractTimeoutError, ObserveTimeoutError, StagehandInvalidArgumentError, } from "../../lib/v3/types/public/sdkErrors.js";
...
describe("No-timeout success paths", () => {
    ...
    it("extract() captures the current viewport when screenshot is enabled", async () => {
        ...
        expect(fakePage
            .screenshot).toHaveBeenCalledWith({ fullPage: false, type: "png" });
        expect(extractInferenceMock).toHaveBeenCalledWith(expect.objectContaining({
