...
export async function deepLocatorThroughIframes(page, root, xpathOrSelector) {
 ...
 */
export async function resolveLocatorTarget(page, root, selectorRaw) {
...
export async function resolveLocatorWithHops(page, root, selectorRaw) {
...
export function deepLocatorFromPage(page, root, selector) {
