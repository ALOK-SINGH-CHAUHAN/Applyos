...
export function resolveCssSelector(selectorRaw, targetIndexRaw) {
...
export function resolveCssSelectorPierce(selectorRaw, targetIndexRaw) {
    const selector = String(selectorRaw ?? "").trim();
    if (!selector)
        return null;
    const targetIndex = parseTargetIndex(targetIndexRaw);
...
export function resolveTextSelector(rawNeedle, targetIndexRaw) {
...
export function resolveXPathMainWorld(rawXp, targetIndexRaw) {
    const targetIndex = parseTargetIndex(targetIndexRaw);
