 ...
 */
export async function executeGoogleCustomTool(toolName, toolArgs, tools, functionCall, logger) {
    try {
        logger({
            category: "agent",
 ...
 */
export function isCustomTool(functionCall, tools) {
 ...
 */
export function convertToolSetToFunctionDeclarations(tools) {
