...
describe("isChromeNotFoundError", () => {
    it("matches chrome-launcher not-installed and path-not-set codes", () => {
        expect(isChromeNotFoundError(Object.assign(new Error("No Chrome installations found."), {
            code: "ERR_LAUNCHER_NOT_INSTALLED",
        }))).toBe(true);
        expect(isChromeNotFoundError(Object.assign(new Error("CHROME_PATH must be set"), {
