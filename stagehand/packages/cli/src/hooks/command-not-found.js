...
const hook = async function ({ config, id }) {
    ...
    try {
        ...
        const didYouMean = suggestion
            ...
            : "";
        process.stderr.write(`"${config.bin} ${displayAttempted}" is not a ${config.bin} command.${didYouMean} Run ${config.bin} --help for all commands.\n`);
    }
    catch {
