...
export default class Upload extends BrowseCommand {
    static description = "Upload one or more files into a file input by snapshot ref, XPath, or selector.";
    static examples = [
    ...
    async run() {
        ...
        await runDriverCommandFromFlags("upload", { files: [args.file, ...(flags.file ?? [])], selector: args.selector }, flags);
    }
}
