...
import { listContextAliases, } from "../../../lib/cloud/contexts-store.js";
...
export default class ContextsList extends BrowseCommand {
    static description = "List Browserbase contexts you have saved locally with a name.";
    static examples = [
...
function outputContextsTable(contexts, options) {
    outputTable(contexts, [
        {
            header: "Name",
            maxWidth: 24,
