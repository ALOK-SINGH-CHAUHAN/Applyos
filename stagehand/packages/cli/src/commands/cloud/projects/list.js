...
export default class ProjectsList extends BrowseCommand {
    static description = "List projects visible to the current API key.";
    static examples = [
        "browse cloud projects list",
        "browse cloud projects list --json",
    ];
    static flags = { ...apiCommonFlags, ...outputFormatFlags };
    async run() {
...
function outputProjectsTable(projects, options) {
