...
import { createBrowserbaseClient, outputJson, withBrowserbaseApi, writeBinaryOutput, } from "../../../../lib/cloud/api.js";
import { apiCommonFlags, toApiOptions } from "../../../../lib/cloud/flags.js";
import { BrowseCommand } from "../../../../base.js";
export default class SessionsDownloadsGet extends BrowseCommand {
    static description = "Download Browserbase session files as a ZIP archive.";
    static examples = [
