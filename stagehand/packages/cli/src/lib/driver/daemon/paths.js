...
export function runtimeDir() {
    return (process.env.BROWSE_DAEMON_DIR ??
        path.join(os.tmpdir(), defaultRuntimeDirName()));
}
export function sanitizeSessionName(session) {
...
function defaultRuntimeDirName() {
