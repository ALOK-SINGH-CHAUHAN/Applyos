...
export declare function collectForwardedEnv(env?: NodeJS.ProcessEnv): Promise<ForwardedEnv | undefined>;
/**
 ...
 */
export declare function forwardedEnvSignature(forwardedEnv: ForwardedEnv | undefined): string;
