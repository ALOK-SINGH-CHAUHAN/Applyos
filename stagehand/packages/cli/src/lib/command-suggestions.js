 ...
 */
export const aliasSuggestions = new Map([
 ...
 */
export function extractCommandTokens(id) {
    const tokens = [];
 ...
 */
function prefixDistance(tokens, commandId) {
 ...
 */
export function suggestCommand(id, commandIds) {
