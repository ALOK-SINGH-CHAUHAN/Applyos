...
const groupLinesIntoSections = (lines) => {
    let sections = {};
    let sectionName = exports.PROFILE_SECTION;
    let sectionLines = [];
...
exports.groupLinesIntoSections = groupLinesIntoSections;
...
const isSectionTitle = (line, lineNumber) => {
    ...
    if ((0, common_features_1.isBold)(textItem) && (0, common_features_1.hasLetterAndIsAllUpperCase)(textItem)) {
        return true;
    }
    ...
    if (textHasAtMost2Words &&
        (0, common_features_1.hasOnlyLettersSpacesAmpersands)(textItem) &&
