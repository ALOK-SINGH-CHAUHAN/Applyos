...
exports.groupTextItemsIntoLines = void 0;
...
const shouldAddSpaceBetweenText = (leftText, rightText) => {
    ...
    const conditions = [
        [":", ",", "|", ".", ...bullet_points_1.BULLET_POINTS].includes(leftTextEnd) &&
            rightTextStart !== " ",
        leftTextEnd !== " " && ["|", ...bullet_points_1.BULLET_POINTS].includes(rightTextStart),
    ];
