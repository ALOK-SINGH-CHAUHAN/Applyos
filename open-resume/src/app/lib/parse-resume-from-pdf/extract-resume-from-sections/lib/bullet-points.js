...
exports.getDescriptionsLineIdx = exports.getBulletPointsFromLines = exports.BULLET_POINTS = void 0;
/**
...
exports.getBulletPointsFromLines = getBulletPointsFromLines;
const getMostCommonBulletPoint = (str) => {
    const bulletToCount = exports.BULLET_POINTS.reduce((acc, cur) => {
        acc[cur] = 0;
        return acc;
    }, {});
    let bulletWithMostCount = exports.BULLET_POINTS[0];
...
const getFirstBulletPointLineIdx = (lines) => {
    for (let i = 0; i < lines.length; i++) {
        for (let item of lines[i]) {
            if (exports.BULLET_POINTS.some((bullet) => item.text.includes(bullet))) {
                return i;
            }
        }
    }
...
exports.getDescriptionsLineIdx = getDescriptionsLineIdx;
