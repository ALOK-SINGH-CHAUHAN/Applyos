...
exports.divideSectionIntoSubsections = void 0;
...
const divideSectionIntoSubsections = (lines) => {
    ...
    if (subsections.length === 1) {
        const isLineNewSubsectionByBold = (line, prevLine) => {
            if (!(0, common_features_1.isBold)(prevLine[0]) &&
                (0, common_features_1.isBold)(line[0]) &&
                // Ignore bullet points that sometimes being marked as bolded
                !bullet_points_1.BULLET_POINTS.includes(line[0].text)) {
                return true;
            }
            return false;
        };
...
exports.divideSectionIntoSubsections = divideSectionIntoSubsections;
