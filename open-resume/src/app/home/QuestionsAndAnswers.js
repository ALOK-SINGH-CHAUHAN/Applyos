...
exports.QuestionsAndAnswers = void 0;
const documentation_1 = require("components/documentation");
const QAS = [
    {
        question: "Q1. What is a resume builder? Why resume builder is better than resume template doc?",
        answer: (<>
        <p>
    ...
    {
        question: "Q2. What uniquely sets OpenResume apart from other resume builders and templates?",
        answer: (<>
        <p>
          Other than OpenResume, there are some great free resume builders out
          there, e.g. <documentation_1.Link href="https://rxresu.me/">Reactive Resume</documentation_1.Link>,{" "}
          <documentation_1.Link href="https://flowcv.com/">FlowCV</documentation_1.Link>. However, OpenResume
    ...
    },
    {
        ...
        <documentation_1.Link href="https://github.com/xitanggg">Xitang Zhao</documentation_1.Link> and designed
        by <documentation_1.Link href="https://www.linkedin.com/in/imzhi">Zhigang Wen</documentation_1.Link> as
    ...
    },
    {
        ...
        <p>
          ...
          at{" "}
          <documentation_1.Link href="mailto:hello@open-resume.com">hello@open-resume.com</documentation_1.Link>{" "}
          or{" "}
          <documentation_1.Link href="https://github.com/xitanggg/open-resume/issues/new">
            open an issue
...
const QuestionsAndAnswers = () => {
    return (<section className="mx-auto max-w-3xl divide-y divide-gray-300 lg:mt-4 lg:px-2">
      <h2 className="text-center text-3xl font-bold">Questions & Answers</h2>
      <div className="mt-6 divide-y divide-gray-300">
        {QAS.map(({ question, answer }) => (<div key={question} className="py-6">
