...
exports.ResumePDFIcon = ResumePDFIcon;
const { width, height, fill } = styles_1.styles.icon;
const PDFIcon = ({ pathD }) => (<renderer_1.Svg viewBox="0 0 512 512" style={{ width, height }}>
    <renderer_1.Path d={pathD} fill={fill}/>
  </renderer_1.Svg>);
const SVGIcon = ({ pathD }) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width, height, fill }}>
    <path d={pathD}/>
  </svg>);
