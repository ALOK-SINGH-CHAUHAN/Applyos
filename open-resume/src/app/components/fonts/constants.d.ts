 ...
 */
export declare const ENGLISH_FONT_FAMILIES: ("Roboto" | "Lato" | "Montserrat" | "OpenSans" | "Raleway" | "Caladea" | "Lora" | "RobotoSlab" | "PlayfairDisplay" | "Merriweather")[];
type EnglishFontFamily = (typeof ENGLISH_FONT_FAMILIES)[number];
export declare const NON_ENGLISH_FONT_FAMILIES: readonly ["NotoSansSC"];
type NonEnglishFontFamily = (typeof NON_ENGLISH_FONT_FAMILIES)[number];
export declare const NON_ENGLISH_FONT_FAMILY_TO_LANGUAGE: Record<NonEnglishFontFamily, string[]>;
export type FontFamily = EnglishFontFamily | NonEnglishFontFamily;
export declare const FONT_FAMILY_TO_STANDARD_SIZE_IN_PT: Record<FontFamily, number>;
export declare const FONT_FAMILY_TO_DISPLAY_NAME: Record<FontFamily, string>;
export {};
