...
export function generateStaticParams() {
    return routing.locales.flatMap((locale) => Array.from({ length: 6 }, (_, i) => ({
        slug: `${i}`,
        locale,
    })));
}
...
export default async function PortfolioDetail(props) {
    ...
    return (<>
      ...
      <div className="mt-5 text-center text-sm">
        ...
        <a className="text-blue-700 hover:border-b-2 hover:border-blue-700" href="https://www.coderabbit.ai?utm_source=next_js_starter&utm_medium=github&utm_campaign=next_js_starter_oss_2025">
          CodeRabbit
        </a>
      </div>
